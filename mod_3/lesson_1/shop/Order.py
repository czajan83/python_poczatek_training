class Order:
    ...
    def __init__(self, purchaser_name, purchaser_last_name, order_list=None):
        ...
        if order_list is None:
            self.__order_list = []
        elif len(order_list) > Order.MAX_LENGTH:
            self.__order_list = order_list[:Order.MAX_LENGTH]
        else:
    ...
    def add_product_to_order_list(self, order_element):
        if len(self.__order_list) == Order.MAX_LENGTH:
