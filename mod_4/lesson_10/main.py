...
def exercise_1():
    test_product__eq__method(("jabłko", Category.FRUITS, 45, 2222), ("jabłko", Category.FRUITS, 45, 3335), True)
    test_product__eq__method(("jabłko", Category.FRUITS, 45, 3333), ("jabłko", Category.FRUITS, 45, 3335), False)
    test_product__eq__method(("jabłko", Category.FRUITS, 45, 3333), ("gruszka", Category.FRUITS, 45, 3335), True)
    test_product__eq__method(("jabłko", Category.FRUITS, 45, 3333), ("gruszka", Category.FRUITS, 45, 3335), False)
